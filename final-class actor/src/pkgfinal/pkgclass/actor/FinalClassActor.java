 ...
 */
package pkgfinal.pkgclass.actor;

/**
 *
 * @author ELCOT
 */
public class FinalClassActor {
    ...
    class malayalam-actor extends actor
    {
        ...
        {
            super.name="Mohanlal";
            super.place-of-birth="kerala";
        }
        Malayalam actor(string name1,string place)
        {
    super.name=name1;
    super.place-of-birth=place;
        }
        String actor-state;
        void actor-state()
        {
